    ...
    <style>
        * {
        ...
        body {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), linear-gradient(135deg, #2c3e50 0%, #34495e 50%, #2c3e50 100%);
            min-height: 100vh;
            display: flex;
...
<body>
    <header class="header">
        ...
        <nav class="nav-pills">
            <a href="index.php" class="nav-pill active">Home</a>
